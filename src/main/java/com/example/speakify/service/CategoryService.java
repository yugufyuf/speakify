...
public class CategoryService {
    ...
    public CategoryResponse updateCategory(String id, CategoryRequest categoryRequest) {
        Category category = categoryRepository.findById(id)
                .orElseThrow(() -> new AppException(ErrorCode.CATEGORY_NOT_EXIST));
        if(categoryRequest.getSubCategory() != null) {
    ...
    public String deleteSubCategory(CategoryRequest categoryRequest) {
        Category category = categoryRepository.findByMainCategoryAndSubCategory(categoryRequest.getMainCategory(),
                categoryRequest.getSubCategory()).orElseThrow(() -> new AppException(ErrorCode.CATEGORY_NOT_EXIST));
        categoryRepository.delete(category);
        if(categoryRepository.existsByMainCategoryAndSubCategory(categoryRequest.getMainCategory(),
                categoryRequest.getSubCategory())) return "Delete failed";
        return "Delete successful";
    }
}
